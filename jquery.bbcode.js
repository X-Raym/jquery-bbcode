...
(function() {
    ...
    _render = function(e, d) {
        ...
        a.quotespecific = {
            re: /\[quote=(?:"|&quot;)(.*?)(?:"|&quot;)\]([\s\S]*?)\[\/quote\]/ig,
            sub: function(a, b, c) {
                return b + " wrote: <blockquote><p>" + c + "<p></blockquote>"
            }
        };
        a.size = {
            re: /\[size=(\d+)\]([\s\S]*?)\[\/size\]/ig,
            sub: function(a, b, c) {
                return '<span style="font-size:' + b + '%;">' + c + "</span>"
            }
        };
        a.strikethrough = {
            re: /\[s\]([\s\S]*?)\[\/s\]/ig,
        ...
        a.center = {
            ...
            sub: function(a, b) {
                return '<div style="text-align:center;">' + b + "</div>"
            }
        };
        a.color = {
        ...
        a.youtube = {
            ...
            sub: function(a, b) {
                return '<iframe class="youtube-player" type="text/html" width="640" height="385" src="http://www.youtube.com/embed/' + b + '" frameborder="0"></iframe>'
            }
        };
        if (f.newlines) a.newlines = {
            re: /\n\r?/g,
            sub: function() {
                return "<br/>"
            }
        };
        for (var h in a) a.hasOwnProperty(h) && (e = e.replace(a[h].re, a[h].sub));
        return e
    };
    d.render = _render;
    typeof module !== "undefined" && module.exports ? module.exports = d : this.bbcode = d
})();
